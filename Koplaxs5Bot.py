...
cl = LINETCR.LINE() #Diks
cl.login(token="EmUDfxSei8h3Ebki9TL9.fbMcAjl5m9eOdy9zPiwPkq.TZMY2JY5GdYhQ6/GaruH+QuHCD0p15Z1ADLyl0SGZlE=")
cl.loginResult()

ki = LINETCR.LINE() #Mizzi
ki.login(token="EmmdbEtX3ynVo4QHNAla.jRtusaIE4DcH+SxjLmsK6G.AFNVfzGjVux/Bkak8NKmSJsxSzKE1v2CMF5a2bMrIIk=")
ki.loginResult()

kk = LINETCR.LINE() #Temmy
kk.login(token="Em66sAMogLLCgjsE1oS0.EaAcuovi80UBqbkxEcw4ia.PzDJjJvnEpQ00jx1OZm80a+lGfBrImOd+YUwOEawa7Q=")
kk.loginResult()

kc = LINETCR.LINE() #Gintama
kc.login(token="EmDp604SDbN1GoZOsXE6.eplTeWyMNHFdEPB9X26hDG.zCgiLnFG8JN+WAHtujfpv39eJnkxJXW8B3yFHjVococ=")
kc.loginResult()

ks = LINETCR.LINE() #Fuckyou
ks.login(token="EmBB3ceruB3pKZa5FiXe.+urLDlQgcsoUTdJjm8G2ZG.YhrOa06fmFa6W5XxsS8cZk6SAPAW36VOFD0+VnzcTxs=")
ks.loginResult()
...
mid = cl.getProfile().mid #Diks
Amid = ki.getProfile().mid #Mizzi
Bmid = kk.getProfile().mid #Temmy
Cmid = kc.getProfile().mid #Gintama
Dmid = ks.getProfile().mid #Fuckyou
...
☆ SMULE INDONESIA FAMILY ☆
☆ OWNER PROTECT ☆
☆ We Are The One☆


Minat? Silahkan PM!
Idline: http://line.me/chiqaladiksa""",
    "lang":"JP",
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            elif "Diks kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Mizzi kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_third kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Temmy kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Diks invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Mizzi invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("tinvite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Temmy invite " in msg.text:
              if msg.from_ in admin:
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Diks buka qr","Diks open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done My Boss")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Mizzi buka qr","Mizzi open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Temmy open qr","Temmy buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Diks close qr","Diks tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Mizzi tutup qr","Mizzi close qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Temmy tutup qr","Temmy close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            ...
            elif msg.text in ["Kaboor","Lassist","Go"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
  ...
  #-----------------End-----------
            elif msg.text in ["Say hallo"]:
                ki.sendText(msg.to,"Helllooo kaka2 😎😎😎")
                kk.sendText(msg.to,"Helllooo Semuanyaa 😆😆😆")
                kc.sendText(msg.to,"Hellooo Guys😷😷😷")

#-----------------------------------------------
            elif msg.text in ["Say pekok"]:
                ki.sendText(msg.to," pekok wkwkwkkwkw")
                kk.sendText(msg.to,"maaf kak im cuma di suruh")
                kc.sendText(msg.to,"Jangan baper ya kak 😉😉😉😉")
            elif msg.text in ["Say love you"]:
                ki.sendText(msg.to,"Love you 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Love you 􀜁􀅔sho much Har Har􏿿")
                kc.sendText(msg.to,"Love you 􀜁􀅔mmuaacchh Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Kang Sayur Always On")
                ki.sendText(msg.to,"Kang Baper Always On")
                kk.sendText(msg.to,"Kang Modus Always On")
                kc.sendText(msg.to,"Kang Becak Always On")
                ks.sendText(msg.to,"Kang Boong Always On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Anu Kaseep 😜")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐SOMPLAK⭐⭐👈\n\n™SMULE INDONESIA FAMILY™")
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Hallo=====\n[★]Bot Protect On\n[★]\n[★]Selfbot On[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nBudayakan kedamayan\nBetul??? My own @chiqaladiksa\nBukan Promo Lho Kak\n===[★]Diks Bot[★]===")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^Diks Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nChiqaladiksa")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Hallo=====\n[★]Bot Protect On\n[★]\n[★]Selfbot On[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nMaaf ini auto\nHehee Id Line @chiqaladiksa\nBukanPromo Lho Kak\n===[★]Diks Bot Protect[★]===")
                    print "Like"
                except:
                    pass
            else:
